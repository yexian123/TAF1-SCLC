...
####Rudin_Correlation_of_epigenetic_related_genes_with_CD8_ratio_in_SCLC####
...
####TU_cohort_Survival_Analysis_with_FDR_and_Power_Analysis ####
...
####TU_cohort_TAF1-protein-normal-tumor ####
target_gene <- "TAF1"
...
####IMPOWER133_Survival_Analysis_with_FDR_and_Power_Analysis ####
...
####Wang_Correlation_of_TAF1_with_CD8_ratio_in_SCLC####
effector_ratio <- read.csv(file = "effector_cd8_ratio.csv")
Idents(seu_obj) <- "mainmarkers"
...
mainmarkers <- c(  "CD68",  "CD14",  "MRC1",  "CD86",  "FCGR3A",  "FABP4",  "C1QA",  "IFI27",
  "IL1B",  "SOCS3",  "MSR1",  "MS4A7",  "RARRES1",  "FOLR2",  "VCAN",  "S100A12",  "FCER1A",
  "CD1C",  "IL7R",  "SPP1",  "RNASE1",  "MKI67",  "TOP2A")
cowplot::plot_grid(ncol = 2, 
                   DimPlot(Mono_macro, 
                           group.by = "RNA_snn_res.0.2",
                           label = TRUE,
